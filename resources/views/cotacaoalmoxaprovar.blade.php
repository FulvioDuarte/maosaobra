...
<main id="main-content">
    ...
    <div class="d-flex align-items-center mb-2">
        ...
        <span class="h5 mb-0">Gestão de Compras Consumo - APROVAR COTAÇÃO - Pedido #{{ $pedido->numero_pedido }}</span>
    </div>
    ...
    <div class="container-fluid">
        <div class="p-2 mb-1" style="background: #fff; border: 1px solid #dee2e6; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
            <form action="{{ route('gravaaprovado') }}" method="POST" enctype="multipart/form-data">
                @csrf
