...
<body> 
    ...
    <form action="pesquisa" method="POST" id="form-barras">
    @csrf
    ...
    @forelse ($produtos as $produto)  
        <div style="display: flex; align-items: center; justify-content: space-between; gap: 10px; width: 100%;">
            ...
            <a href="{{ route('alterar', ['id' => $produto->id]) }}" style="text-decoration: none; flex-grow: 1;">
            ...
            <form method="POST" action="{{ route('imprimir') }}" style="margin: 0;">
                @csrf
    ...
    @empty
        ...
        <div class="d-flex justify-content-between align-items-center my-2 mx-1">
            @if ($msg <> '')
                <a href="{{ route('cadastrarproduto') }}" class="btn btn-success"> Csdastrar Produto</a>
            @endif
        </div>
    @endforelse
